...
describe("Portfolio Website Tests", () => {
  describe("Main Component", () => {
    ...
    it("displays footer with current year", () => {
      ...
      expect(
        screen.getByText(`© ${currentYear} Ryan Koskela`),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Routing", () => {
    ...
    it("renders projects component on /portfolio path", () => {
      const { container } = renderWithRouter(<Main />, ["/portfolio"]);
  ...
  describe("Navigation Links", () => {
    it("has correct href attributes", () => {
      ...
      const projectsLink = screen.getByText("Portfolio");
  ...
  describe("Component Accessibility", () => {
    ...
    it("projects component has accessible close button", () => {
      renderWithRouter(<Main />, ["/portfolio"]);
      const closeButton = screen.getByLabelText("Close portfolio view");
  ...
  describe("Close Button Functionality", () => {
    ...
    it("projects close button navigates home", () => {
      const { history } = renderWithRouter(<Main />, ["/portfolio"]);
      const closeButton = screen.getByLabelText("Close portfolio view");
