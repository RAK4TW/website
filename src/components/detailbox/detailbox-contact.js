...
export default function DetailboxContact(props) {
  return (
    <Animated animationIn="fadeInRight" animationOut="fadeOutDown" isVisible={true} animationInDuration="500">
    <div className="white-bg">
      <div className="detailbox">
        <div className="row">
          <div className="col-9"><h1>Contact</h1></div><div className="col-3 closex text-right" onClick={() => {props.history.replace("/")}}>Close [X]</div></div>
        <div>
