...
describe("Accessibility Tests", () => {
  ...
  describe("DetailboxAbout Accessibility", () => {
    it("should not have any accessibility violations", async () => {
      const { container } = renderWithRouter(
        <DetailboxAbout history={createMemoryHistory()} />,
      );
      const results = await axe(container);
      expect(results).toHaveNoViolations();
    });
    ...
    it("should have accessible download link", () => {
      ...
      expect(downloadLink).toHaveAttribute(
        "aria-label",
        "Download Ryan Koskela's resume",
      );
  ...
  describe("DetailboxProjects Accessibility", () => {
    it("should not have any accessibility violations", async () => {
      const { container } = renderWithRouter(
        <DetailboxProjects history={createMemoryHistory()} />,
      );
      const results = await axe(container);
      expect(results).toHaveNoViolations();
    });
  ...
  describe("DetailboxContact Accessibility", () => {
    ...
    it("should have accessible social media links", () => {
      ...
      expect(instagramLink).toHaveAttribute(
        "aria-label",
        "Visit Ryan's Instagram profile",
      );
  ...
  describe("Screen Reader Compatibility", () => {
    it("should have proper ARIA labels", () => {
      ...
      const downloadLink = screen.getByLabelText(
        "Download Ryan Koskela's resume",
      );
