...
describe("Portfolio Website - Basic Tests", () => {
  ...
  it("displays navigation links", () => {
    ...
    expect(
      screen.getByRole("link", { name: "Ryan Koskela" }),
    ).toBeInTheDocument();
  ...
  it("displays subheading text", () => {
    ...
    expect(
      screen.getByText(
        /Web developer, writer, sports and food\/drink aficionado/,
      ),
    ).toBeInTheDocument();
  });
  ...
  it("navigation links have correct href attributes", () => {
    ...
    const projectsLink = screen.getByRole("link", { name: /Portfolio/i });
  ...
  it("displays mainbox items", () => {
    ...
    expect(screen.getByTestId("mainbox-portfolio")).toBeInTheDocument();
  ...
  it("displays correct headers for mainbox items", () => {
    ...
    expect(mainboxesContainer).toHaveTextContent("Portfolio");
